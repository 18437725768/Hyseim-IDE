...
export abstract class MenubarControl extends Disposable {
	...
	protected topLevelTitles: { [menu: string]: string } = {
		...
		'Project': nls.localize({ key: 'mProject', comment: ['&& denotes a mnemonic'] }, "&&Project"),
		'Build': nls.localize({ key: 'mBuild', comment: ['&& denotes a mnemonic'] }, "&&Build"),
	...
	constructor(
		...
		this.menus = {
			...
			'Project': this._register(this.menuService.createMenu(MenuId.MenubarMaixMenu, this.contextKeyService)),
			'Build': this._register(this.menuService.createMenu(MenuId.MenubarBuildMenu, this.contextKeyService)),
