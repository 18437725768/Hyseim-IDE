...
export const ACTION_CATEGORY_OPEN = localize('hyseim.open', 'Open');
...
export const ACTION_LABEL_OPEN_EXTERNAL_TERMINAL = localize('workbench.action.hyseim.open.terminal', 'Open System Terminal');
