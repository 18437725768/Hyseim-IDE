import { QuotingBuffer, UnQuotedBuffer } from 'vs/hyseim/vs/platform/serialPort/flasher/node/quotedBuffer';
import { EscapeBuffer, UnEscapeBuffer } from 'vs/hyseim/vs/platform/serialPort/flasher/node/escapeBuffer';
import { ISPParseBuffer, ISPSerializeBuffer } from 'vs/hyseim/vs/platform/serialPort/flasher/node/ispBuffer';
import { Disposable } from 'vs/base/common/lifecycle';
import { ISPError, ISPOperation, ISPRequest, ISPResponse } from 'vs/hyseim/vs/platform/serialPort/flasher/node/bufferConsts';
import { createReadStream, ReadStream } from 'fs';
import { GarbageData, StreamChain } from 'vs/hyseim/vs/platform/serialPort/flasher/node/streamChain';
import { CancellationToken } from 'vs/base/common/cancellation';
import { Event } from 'vs/base/common/event';
import { addDisposableEventEmitterListener } from 'vs/hyseim/vs/base/node/disposableEvents';
import { TimeoutBuffer } from 'vs/hyseim/vs/platform/serialPort/flasher/node/timoutBuffer';
...
import { eachChunkPadding } from 'vs/hyseim/vs/platform/serialPort/flasher/node/chunkBuffer';
import { ISerialPortInstance, ISerialPortService } from 'vs/hyseim/vs/services/serialPort/common/type';
import { IChannelLogger } from 'vs/hyseim/vs/services/channelLogger/common/type';
import { throwNull } from 'vs/hyseim/vs/base/common/assertNotNull';
import { CHIP_BAUDRATE, PROGRAM_BASE } from 'vs/hyseim/vs/platform/serialPort/flasher/common/chipDefine';
import { memoize } from 'vs/base/common/decorators';
import { localize } from 'vs/nls';
import { SpeedMeter } from 'vs/hyseim/vs/base/common/speedShow';
import { DATA_LEN_WRITE_FLASH, DATA_LEN_WRITE_MEMORTY } from 'vs/hyseim/vs/platform/open/common/chipConst';
import { HexDumpLoggerStream } from 'vs/hyseim/vs/base/node/loggerStream';
import { stringifyMemoryAddress } from 'vs/hyseim/vs/platform/serialPort/flasher/common/memoryAllocationCalculator';
import { IInstantiationService } from 'vs/platform/instantiation/common/instantiation';
import { streamToBuffer } from 'vs/hyseim/vs/base/node/collectingStream';
import { canceled } from 'vs/base/common/errors';
import { packISPWritePackage } from 'vs/hyseim/vs/platform/serialPort/flasher/node/ispFlashPackage';
import { DeferredPromise } from 'vs/hyseim/vs/base/common/deferredPromise';
import { boardRebootSequence, BOOT_BOARD_TYPE } from 'vs/hyseim/vs/services/serialPort/common/rebootSequence';
import { flashDataBufferPack } from 'vs/hyseim/vs/platform/serialPort/flashCommon/node/dataBufferPack';
import { flashProgramBufferPack } from 'vs/hyseim/vs/platform/serialPort/flashCommon/node/programBufferPack';
import { tryRebootDevBoard } from 'vs/hyseim/vs/platform/serialPort/flashCommon/node/tryReboot';
import { sha256 } from 'vs/hyseim/vs/base/node/hash';
