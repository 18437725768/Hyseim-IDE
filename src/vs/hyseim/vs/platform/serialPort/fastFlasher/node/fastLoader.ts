...
import { boardRebootSequence, BOOT_BOARD_TYPE, getSerialPortNormalState } from 'vs/hyseim/vs/services/serialPort/common/rebootSequence';
...
import { DATA_LEN_WRITE_FLASH } from 'vs/hyseim/vs/platform/open/common/chipConst';
import { eachChunkPaddingWithSize, IBufferChunk } from 'vs/hyseim/vs/platform/serialPort/flasher/node/chunkBuffer';
import { msleep, timeout } from 'vs/hyseim/vs/base/common/timeout';
import { ResponseHello, responseIsHello, responseIsWriteOk, ResponseWriteOk } from 'vs/hyseim/vs/platform/serialPort/fastFlasher/node/response';
import { SimpleWorkerPool } from 'vs/hyseim/vs/base/common/workerPool';
...
import { flashDataBufferPackFastLoader } from 'vs/hyseim/vs/platform/serialPort/flashCommon/node/dataBufferPack';
import { SerialReduceStream } from 'vs/hyseim/vs/platform/serialPort/fastFlasher/node/serialReduceStream';
