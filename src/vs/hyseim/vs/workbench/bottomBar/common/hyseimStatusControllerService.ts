...
import { IHyseimStatusControllerService, IPartMyStatusBarItem, StatusBarLeftLocation } from 'vs/hyseim/vs/workbench/bottomBar/common/type';
import { MyStatusBarItem } from 'vs/hyseim/vs/workbench/bottomBar/common/myStatusBarItem';
import { IContextKeyService } from 'vs/platform/contextkey/common/contextkey';
import { DisposableSet } from 'vs/hyseim/vs/base/common/lifecycle/disposableSet';
import { StackArray } from 'vs/hyseim/vs/base/common/lifecycle/stackArray';
...
export class HyseimStatusControllerService implements IDisposable, IHyseimStatusControllerService {
