...
import { ApplicationMenuStructure, MyMenu, MyMenuRegistry, MyMenuSeparator, MySubMenu }
    from 'vs/hyseim/vs/base/common/menu/buildMenu'
let lastMenuId = 5000;

function createMenu(s: MyMenuRegistry, parent: MenuId) {
    let currentIndex = 0, className = 'hyseim_menu_' + parent.toFixed(0);
...
createMenu(ApplicationMenuStructure, MenuId.MenubarBuildMenu);
