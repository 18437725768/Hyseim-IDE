...
import { environmentPathVarName, getActualEnvironmentKey, PathListSep, PlatformPathArray, ShellExportCommand } from 'vs/hyseim/vs/base/common/platformEnv';
import { writeFile } from 'vs/base/node/pfs';
import { resolvePath } from 'vs/hyseim/vs/base/common/resolvePath';
import { IConfigurationService } from 'vs/platform/configuration/common/configuration';
import { CONFIG_KEY_EXTRA_PATH } from 'vs/hyseim/vs/base/common/configKeys';
...
export function getLimitedEnvironment(nodePathService: INodePathService, configurationService: IConfigurationService): { env: MapLike<string>, path: PlatformPathArray } {
	...
	pathHandler.prepend(...nodePathService.hyseimPaths());
