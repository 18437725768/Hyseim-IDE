...
import { normalizePosixPath } from 'vs/hyseim/vs/base/common/resolvePath';
import { IConstructorSignature1, IConstructorSignature2 } from 'vs/platform/instantiation/common/instantiation';
import { EditorId, IJsonEditor, IJsonEditorInput } from 'vs/hyseim/vs/workbench/jsonGUIEditor/editor/common/type';
import { Extensions as EditorInputExtensions, IEditorInput, IEditorInputFactoryRegistry } from 'vs/workbench/common/editor';
import { CommonJsonEditorInputFactory } from 'vs/hyseim/vs/workbench/jsonGUIEditor/editor/common/inputFactory';
import { Extensions as EditorExtensions, IEditorRegistry } from 'vs/workbench/browser/editor';
import { JsonEditorDescriptor } from 'vs/hyseim/vs/workbench/jsonGUIEditor/editor/browser/editorDescriptor';
...
import { JsonEditorExtensions } from 'vs/hyseim/vs/workbench/jsonGUIEditor/common/type';
