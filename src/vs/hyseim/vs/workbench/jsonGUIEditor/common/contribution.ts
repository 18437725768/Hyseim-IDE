...
import { CONTEXT_JSON_GUI_EDITOR, CONTEXT_JSON_GUI_EDITOR_JSON_MODE } from 'vs/hyseim/vs/workbench/jsonGUIEditor/editor/common/context';
import {
...
import { JsonEditorHandlerContribution } from 'vs/hyseim/vs/workbench/jsonGUIEditor/editor/common/replaceEditor';
import { LifecyclePhase } from 'vs/platform/lifecycle/common/lifecycle';
import { registerExternalAction } from 'vs/hyseim/vs/workbench/actionRegistry/common/registerAction';
import { ShowGuiEditorAction, ShowJsonEditorAction } from 'vs/hyseim/vs/workbench/jsonGUIEditor/editor/common/switchEditorAction';
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		...
		iconLocation: {
			dark: URI.parse(require.toUrl('vs/hyseim/vs/platform/vsicons/browser/icons/json_inverse.svg')),
			light: URI.parse(require.toUrl('vs/hyseim/vs/platform/vsicons/browser/icons/json.svg')),
		},
	},
	group: 'navigation',
	order: 1,
...
MenuRegistry.appendMenuItem(MenuId.EditorTitle, {
	command: {
		...
		iconLocation: {
			dark: URI.parse(require.toUrl('vs/hyseim/vs/platform/vsicons/browser/icons/PreferencesEditor_inverse.svg')),
			light: URI.parse(require.toUrl('vs/hyseim/vs/platform/vsicons/browser/icons/PreferencesEditor.svg')),
		},
	},
	group: 'navigation',
	order: 1.1,
