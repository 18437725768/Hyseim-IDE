import 'vs/css!vs/hyseim/vs/workbench/jsonGUIEditor/editor/browser/style';
...
import { AbstractJsonEditorInput, IInputState } from 'vs/hyseim/vs/workbench/jsonGUIEditor/editor/browser/abstractJsonEditorInput';
import { EditorId, IJsonEditor } from 'vs/hyseim/vs/workbench/jsonGUIEditor/editor/common/type';
...
export abstract class AbstractJsonEditor<JsonType, State extends IInputState = {}> extends AbstractTextResourceEditor implements IJsonEditor {
	...
	protected createEditor(parent: HTMLElement): void {
		this.containerRaw = append(parent, $('div.hyseim-json-editor-raw')) as HTMLDivElement;
		hide(this.containerRaw);
		super.createEditor(this.containerRaw);

		// console.log('will create editor: %s', this.descriptor.id);
		const container = this.containerGui = append(parent, $('div.hyseim-json-editor')) as HTMLDivElement;
