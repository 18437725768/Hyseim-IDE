...
import { nullOpenOptions, OpenOptions } from 'vs/hyseim/vs/services/serialPort/common/libraryType';
import { ILocalOptions, nullMonitorOptions, SerialOpenMode } from 'vs/hyseim/vs/workbench/serialMonitor/common/localSettings';
import { ISerialPortInstance, SerialPortItem } from 'vs/hyseim/vs/services/serialPort/common/type';
