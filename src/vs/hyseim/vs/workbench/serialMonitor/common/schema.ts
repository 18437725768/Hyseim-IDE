...
import { IJSONSchemaMapOf } from 'vs/hyseim/vs/base/common/jsonSchemaHelper/type';
import { ILocalOptions } from 'vs/hyseim/vs/workbench/serialMonitor/common/localSettings';
import { standardBaudRate, standardDataBits, standardParity, standardStopBits } from 'vs/hyseim/vs/services/serialPort/common/standard';
