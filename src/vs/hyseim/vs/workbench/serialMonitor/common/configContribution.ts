...
import { CONFIG_CATEGORY, CONFIG_KEY_DEFAULT_SERIAL_BAUDRATE } from 'vs/hyseim/vs/base/common/configKeys';
import { standardBaudRate } from 'vs/hyseim/vs/services/serialPort/common/standard';
