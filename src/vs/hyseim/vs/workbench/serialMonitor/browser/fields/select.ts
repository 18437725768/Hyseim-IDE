import { ISerialMonitorField } from 'vs/hyseim/vs/workbench/serialMonitor/browser/fields/base';
...
import { attachEditableSelectBoxStyler, EditableSelectBox } from 'vs/hyseim/vs/base/browser/ui/editableSelect';
