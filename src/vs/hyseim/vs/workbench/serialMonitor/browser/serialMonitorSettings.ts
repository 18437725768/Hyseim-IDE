...
import { ISerialMonitorSettings, localOptionsScheme, typedValues } from 'vs/hyseim/vs/workbench/serialMonitor/common/schema';
import { ExtendMap } from 'vs/hyseim/vs/base/common/extendMap';
import { fieldWidgetFactory, ISerialMonitorField } from 'vs/hyseim/vs/workbench/serialMonitor/browser/fields/base';
