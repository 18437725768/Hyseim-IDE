import { allSerialPortDefaults, ISerialMonitorSettings, typedValues } from 'vs/hyseim/vs/workbench/serialMonitor/common/schema';
import { IStorageService, StorageScope } from 'vs/platform/storage/common/storage';
import { IConfigurationService } from 'vs/platform/configuration/common/configuration';
import { CONFIG_KEY_DEFAULT_SERIAL_BAUDRATE } from 'vs/hyseim/vs/base/common/configKeys';
import { nullMonitorOptions } from 'vs/hyseim/vs/workbench/serialMonitor/common/localSettings';
import { nullOpenOptions } from 'vs/hyseim/vs/services/serialPort/common/libraryType';
