...
import { SerialPortCopyAction, SerialPortPasteAction } from 'vs/hyseim/vs/workbench/serialMonitor/electron-browser/actions/copyPaste';
import { IContextKey, IContextKeyService } from 'vs/platform/contextkey/common/contextkey';
import { SerialPortClearAction } from 'vs/hyseim/vs/workbench/serialMonitor/electron-browser/actions/clear';
import { Separator } from 'vs/base/browser/ui/actionbar/actionbar';
import { SerialPortShowFindAction } from 'vs/hyseim/vs/workbench/serialMonitor/electron-browser/actions/find';
import { XtermScrollbackBuffer } from 'vs/hyseim/vs/workbench/serialMonitor/electron-browser/iobuffers/output';
...
import { CONTEXT_IN_SERIAL_PORT_OUTPUT, CONTEXT_SERIAL_PORT_HAS_SELECT } from 'vs/hyseim/vs/workbench/serialMonitor/common/actionId';
...
import { OutputWindowFind } from 'vs/hyseim/vs/workbench/serialMonitor/electron-browser/outputWindowFind';
import { SearchAddon } from 'xterm-addon-search';
import { ISerialPortInstance } from 'vs/hyseim/vs/services/serialPort/common/type';
import { FakeTerminalProcessManager } from 'vs/hyseim/vs/workbench/serialMonitor/electron-browser/fakeTerminalProcessManager';
