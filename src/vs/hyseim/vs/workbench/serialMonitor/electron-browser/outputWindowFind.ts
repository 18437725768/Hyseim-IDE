...
import { CONTEXT_SERIAL_PORT_FIND_WIDGET_FOCUSED, CONTEXT_SERIAL_PORT_FIND_WIDGET_INPUT_FOCUSED } from 'vs/hyseim/vs/workbench/serialMonitor/common/actionId';
