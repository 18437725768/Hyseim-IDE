...
import { PROJECT_BUILD_FOLDER_NAME } from 'vs/hyseim/vs/base/common/constants/wellknownFiles';
...
export class CreateZipWithProgramAction extends CreateZipAction {
	...
	constructor(
		...
		super(id, label, flashManagerService, hyseimWorkspaceService, nodeFileSystemService, notificationService);
	}
