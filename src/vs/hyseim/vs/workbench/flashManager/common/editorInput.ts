...
import { AllocInfo, MemoryAllocationCalculator, parseMemoryAddress, stringifyMemoryAddress } from 'vs/hyseim/vs/platform/serialPort/flasher/common/memoryAllocationCalculator';
import { FLASH_MAX_SIZE, FLASH_SAFE_ADDRESS } from 'vs/hyseim/vs/platform/serialPort/flasher/common/chipDefine';
