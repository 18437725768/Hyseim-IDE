...
export const ACTION_ID_FLASH_MANGER_FLASH_ALL = 'workbench.action.hyseim.flash.files';
export const ACTION_LABEL_FLASH_MANGER_FLASH_ALL = localize('uploadAllFiles', 'Upload all files');

export const ACTION_ID_FLASH_MANGER_CREATE_ZIP = 'workbench.action.hyseim.flash.zip';
export const ACTION_LABEL_FLASH_MANGER_CREATE_ZIP = localize('createZip', 'Create zip');

export const ACTION_ID_FLASH_MANGER_CREATE_ZIP_PROGRAM = 'workbench.action.hyseim.flash.zipProgram';
