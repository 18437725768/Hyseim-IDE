...
import { CMakeProjectTypes, ILibraryProject } from 'vs/hyseim/vs/base/common/jsonSchemas/cmakeConfigSchema';
...
export const PACKAGE_MANAGER_ACTION_ID_OPEN_PACKAGE = 'workbench.action.hyseim.openurl.package';
