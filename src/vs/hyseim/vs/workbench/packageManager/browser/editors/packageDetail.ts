...
import { IPackageLocalRemoteInfo, PackageDetailCompletionInput } from 'vs/hyseim/vs/workbench/packageManager/common/editors/packageDetailInput';
...
import { InstallSingleDependencyAction } from 'vs/hyseim/vs/workbench/packageManager/browser/actions/installDependencyAction';
import { asText, IRequestService } from 'vs/platform/request/common/request';
import * as marked from 'vs/base/common/marked/marked';
import { ShowCurrentReleaseNotesAction } from 'vs/workbench/contrib/update/browser/update';
import { IOpenerService } from 'vs/platform/opener/common/opener';
import 'vs/css!vs/hyseim/vs/workbench/packageManager/browser/editors/detailPage';
import { DeleteDependencyAction } from 'vs/hyseim/vs/workbench/packageManager/browser/actions/deleteDependencyAction';
...
export class PackageDetailEditor extends BaseEditor {
	...
	renderBody(body: string): void {
		...
		<html>
			...
			<body class="hyseim-ide ${theme.type}">
