...
export class LocalPackagesListView extends ViewletPanel {
	...
	constructor(
		...
		this._register(hyseimWorkspaceService.onCurrentWorkingDirectoryChange(e => this.show()));
	}
	...
	protected renderBody(container: HTMLElement): void {
		...
		this.list = this.instantiationService.createInstance(WorkbenchPagedList, 'Hyseim-package-local', this.packageList, delegate, [renderer], {
