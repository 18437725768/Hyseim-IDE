...
} from 'vs/hyseim/vs/workbench/packageManager/common/type';
import { Registry } from 'vs/platform/registry/common/platform';
import { Extensions, IViewDescriptor, IViewsRegistry } from 'vs/workbench/common/views';
import { LocalPackagesListView } from 'vs/hyseim/vs/workbench/packageManager/browser/viewletPanels/localPackagesListView';
import { PackageConfigView } from 'vs/hyseim/vs/workbench/packageManager/browser/viewletPanels/packageConfigView';
