...
import { IPackageManagerViewlet, PACKAGE_MANAGER_VIEWLET_ID as VIEWLET_ID } from 'vs/hyseim/vs/workbench/packageManager/common/type';
...
import 'vs/css!vs/hyseim/vs/workbench/packageManager/browser/media/package-manager';
