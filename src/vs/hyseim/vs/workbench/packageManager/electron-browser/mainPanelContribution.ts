...
import { IPackageRegistryService, PACKAGE_MANAGER_TITLE, PACKAGE_MANAGER_VIEWLET_ID as VIEWLET_ID } from 'vs/hyseim/vs/workbench/packageManager/common/type';
import { Extensions as WorkbenchExtensions, IWorkbenchContributionsRegistry } from 'vs/workbench/common/contributions';
import { LifecyclePhase } from 'vs/platform/lifecycle/common/lifecycle';
import { PackageManagerViewletViewsContribution } from 'vs/hyseim/vs/workbench/packageManager/browser/viewletPanels/register';
import { PackageManagerViewlet } from 'vs/hyseim/vs/workbench/packageManager/browser/packageManagerViewlet';
import { EditorDescriptor, Extensions as EditorExtensions, IEditorRegistry } from 'vs/workbench/browser/editor';
import { SyncDescriptor } from 'vs/platform/instantiation/common/descriptors';
import { localize } from 'vs/nls';
import { PackageDetailEditor } from 'vs/hyseim/vs/workbench/packageManager/browser/editors/packageDetail';
import { registerSingleton } from 'vs/platform/instantiation/common/extensions';
import { PackageRegistryService } from 'vs/hyseim/vs/workbench/packageManager/electron-browser/packageRegistryService';
import { PackageBrowserEditor } from 'vs/hyseim/vs/workbench/packageManager/browser/editors/packageBrowser';
