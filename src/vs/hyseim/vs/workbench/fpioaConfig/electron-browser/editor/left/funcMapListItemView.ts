import { IListFuncMapElement, TEMPLATE_ID } from 'vs/hyseim/vs/workbench/fpioaConfig/electron-browser/editor/left/ids';
import { IContextViewService } from 'vs/platform/contextview/browser/contextView';
import { Disposable, dispose, IDisposable } from 'vs/base/common/lifecycle';
import { Emitter, Event } from 'vs/base/common/event';
import { $, addClass, append } from 'vs/base/browser/dom';
import { IOPinPlacement } from 'vs/hyseim/vs/workbench/fpioaConfig/common/packagingTypes';
...
import { attachEditableSelectBoxStyler } from 'vs/hyseim/vs/base/browser/ui/editableSelect';
