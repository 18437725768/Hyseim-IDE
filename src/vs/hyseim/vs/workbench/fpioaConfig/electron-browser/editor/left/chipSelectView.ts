import { IListChipSelectElement, TEMPLATE_ID } from 'vs/hyseim/vs/workbench/fpioaConfig/electron-browser/editor/left/ids';
...
import { selectBoxFindIndex, selectBoxNames, selectBoxSplitter } from 'vs/hyseim/vs/base/browser/ui/selectBox';
