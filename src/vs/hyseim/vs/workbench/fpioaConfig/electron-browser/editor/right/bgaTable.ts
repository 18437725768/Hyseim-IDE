...
import { AbstractTableRender, grid } from 'vs/hyseim/vs/workbench/fpioaConfig/electron-browser/editor/right/abstract';
...
import { ColorMap } from 'vs/hyseim/vs/workbench/fpioaConfig/common/types';
