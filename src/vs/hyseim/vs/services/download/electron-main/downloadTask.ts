...
import { createDownloadId, DownloadID, IDownloadTargetInfo } from 'vs/hyseim/vs/services/download/common/download';
...
import { wrapActionWithFileLock } from 'vs/hyseim/vs/base/node/fileLock';
