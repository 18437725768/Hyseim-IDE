import { INatureProgressStatus } from 'vs/hyseim/vs/platform/config/common/progress';
import { IRequestService } from 'vs/platform/request/common/request';
import { Event } from 'vs/base/common/event';
import { DownloadID, IDownloadTargetInfo, INodeDownloadService } from 'vs/hyseim/vs/services/download/common/download';
import { registerMainSingleton } from 'vs/hyseim/vs/platform/instantiation/common/mainExtensions';
import { DownloadTask, loadIdFromResumeFile } from 'vs/hyseim/vs/services/download/electron-main/downloadTask';
import { doubleExtname } from 'vs/hyseim/vs/base/common/doubleExtname';
import { hash } from 'vs/base/common/hash';
import { ILogService } from 'vs/platform/log/common/log';
import { defaultConsoleLogger } from 'vs/hyseim/vs/platform/log/node/consoleLogger';
