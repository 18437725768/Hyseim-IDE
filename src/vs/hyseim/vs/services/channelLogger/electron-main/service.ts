import { IChannelLogger, LogEvent } from 'vs/hyseim/vs/services/channelLogger/common/type';
...
import { RemoteLogger } from 'vs/hyseim/vs/services/channelLogger/electron-main/remoteLogger';
