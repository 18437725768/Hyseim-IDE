import { ISerialRebootSequence } from 'vs/hyseim/vs/services/serialPort/common/type';
import { SetOptions } from 'vs/hyseim/vs/services/serialPort/common/libraryType';
