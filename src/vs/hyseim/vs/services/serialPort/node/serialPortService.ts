...
import { ISerialPortInstance, ISerialPortManager, ISerialPortService, ISerialRebootSequence, SerialPortItem } from 'vs/hyseim/vs/services/serialPort/common/type';
import { array_has_diff_cb } from 'vs/hyseim/vs/base/common/utils';
...
import { CONFIG_KEY_FILTER_EMPTY_DEVICES } from 'vs/hyseim/vs/base/common/configKeys';
import { IConfigurationService } from 'vs/platform/configuration/common/configuration';
import { SerialPortManager } from 'vs/hyseim/vs/services/serialPort/node/serialPortManager';
import { SerialPortInstance } from 'vs/hyseim/vs/services/serialPort/node/serialPortInstance';
...
class SerialPortService implements ISerialPortService {
	...
	constructor(
		...
		@IHyseimStatusControllerService hyseimStatusControllerService: IHyseimStatusControllerService,
	) {
