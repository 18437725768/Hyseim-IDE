...
import { ACTION_ID_JTAG_GET_ID, ACTION_LABEL_JTAG_GET_ID } from 'vs/hyseim/vs/base/common/menu/openocd';
...
import { RawCopyAction } from 'vs/hyseim/vs/base/electron-browser/rawClipboardAction';
