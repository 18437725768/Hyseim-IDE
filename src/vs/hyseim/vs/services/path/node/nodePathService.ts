...
import { ensureLinkEquals } from 'vs/hyseim/vs/platform/createShortcut/node/shortcuts';
...
import { processEnvironmentPathList } from 'vs/hyseim/vs/base/common/platformEnv';
import { createWindowStartupMenuShortcut } from 'vs/hyseim/vs/workbench/topMenu/node/windows';
import { createLinuxApplicationOrDesktopShortcut } from 'vs/hyseim/vs/workbench/topMenu/node/linux';
import { createMacApplicationsLink } from 'vs/hyseim/vs/workbench/topMenu/node/darwin';
...
export class NodePathService implements INodePathService {
	...
	constructor(
		...
		processEnvironmentPathList.prepend(...this.hyseimPaths());
	}
	...
	getInstallationPath() {
		...
		if (this.environmentService.isBuilt) {
			...
			return resolvePath(this.getSelfControllingRoot(), '../hyseim-ide-shell/build/DebugContents');
		}
	}
