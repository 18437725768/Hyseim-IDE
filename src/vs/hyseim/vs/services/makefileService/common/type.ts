...
import { ICompileInfo, ILibraryProject } from 'vs/hyseim/vs/base/common/jsonSchemas/cmakeConfigSchema';
import { DeepReadonlyArray } from 'vs/hyseim/vs/base/common/type/deepReadonly';
import { localize } from 'vs/nls';

export const ACTION_ID_CREATE_MAKEFILE = 'workbench.action.hyseim.create.makefile';
