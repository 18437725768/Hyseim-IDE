import { ILinkArguments, IProjectInfoResolved } from 'vs/hyseim/vs/services/makefileService/node/resolve';
import { DeepReadonly, DeepReadonlyArray } from 'vs/hyseim/vs/base/common/type/deepReadonly';
...
import { normalizeArray } from 'vs/hyseim/vs/base/common/normalizeArray';
import { CMAKE_CONFIG_FILE_NAME, PROJECT_CONFI_HEADER_FOLDER_NAME, PROJECT_CONFIG_FOLDER_NAME } from 'vs/hyseim/vs/base/common/constants/wellknownFiles';
import { CMAKE_LIST_GENERATED_WARNING, CMakeProjectTypes } from 'vs/hyseim/vs/base/common/jsonSchemas/cmakeConfigSchema';
import { DefineValue } from 'vs/hyseim/vs/services/makefileService/common/type';
import { PathAttachedError } from 'vs/hyseim/vs/platform/marker/common/errorWithPath';
import { missingJsonField } from 'vs/hyseim/vs/base/common/messages';
import { packageJsonArray, packageJsonObject } from 'vs/hyseim/vs/base/common/cmakeTypeHelper';
