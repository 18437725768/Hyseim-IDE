import { CONFIG_KEY_INSERT_PRINT_HOOK, IBeforeBuildEvent, IProjectInfo } from 'vs/hyseim/vs/services/makefileService/common/type';
import { resolvePath } from 'vs/hyseim/vs/base/common/resolvePath';
import { GIT_IGNORE_FILE, HOOK_ENTRY_FILE_NAME, PROJECT_CONFIG_FOLDER_NAME } from 'vs/hyseim/vs/base/common/constants/wellknownFiles';
...
export class BeforeBuildEventResult {
	...
	private async commitSingle(project: IProjectInfo, tempData: IProjectTempData) {
		...
		const logContent = '* Hyseim IDE startup before main().';
...
__attribute__((constructor)) void initialize_hyseim_ide_hook() {
