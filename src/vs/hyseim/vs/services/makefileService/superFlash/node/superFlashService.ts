...
import { CONFIG_KEY_FLASH_SERIAL_BAUDRATE } from 'vs/hyseim/vs/base/common/configKeys';
import { CHIP_BAUDRATE } from 'vs/hyseim/vs/platform/serialPort/flasher/common/chipDefine';
import { PROJECT_CONFI_HEADER_FOLDER_NAME, PROJECT_CONFIG_FOLDER_NAME } from 'vs/hyseim/vs/base/common/constants/wellknownFiles';
