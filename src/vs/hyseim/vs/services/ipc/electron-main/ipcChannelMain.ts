import { IHyseimMainIpcChannel, IHyseimServiceRunnerChannel } from 'vs/hyseim/vs/services/ipc/electron-main/ipc';
import { CancellationToken } from 'vs/base/common/cancellation';
import { Emitter, Event } from 'vs/base/common/event';
import { createDecorator, IInstantiationService, ServicesAccessor } from 'vs/platform/instantiation/common/instantiation';
import { IRemoteProgress } from 'vs/hyseim/vs/services/ipc/common/type';
import { ILogService } from 'vs/platform/log/common/log';
import { inspect } from 'util';
import { registerMainIPC } from 'vs/hyseim/vs/platform/instantiation/electron-main/mainIpcExtensions';
import { registerMainSingleton } from 'vs/hyseim/vs/platform/instantiation/common/mainExtensions';
import { IHyseimServerService } from 'vs/hyseim/vs/services/ipc/electron-main/ipcType';
import { URI } from 'vs/base/common/uri';
import { IMainChannelLogService } from 'vs/hyseim/vs/services/channelLogger/electron-main/service';
import { memoize } from 'vs/base/common/decorators';
import { IPC_ID_IS_ME_FIRST, IPC_ID_STOP_LOG_EVENT } from 'vs/hyseim/vs/base/common/ipcIds';
import { isUndefinedOrNull } from 'vs/base/common/types';

class HyseimIPCMainService implements IHyseimMainIpcChannel {
	_serviceBrand: any;
...
registerMainIPC(IHyseimMainIpcChannel, HyseimIPCMainService);
registerMainSingleton(IHyseimServerService, HyseimIPCMainService);

class RemoteServiceRunner implements IHyseimServiceRunnerChannel {
	_serviceBrand: any;
...
registerMainIPC(IHyseimServiceRunnerChannel, RemoteServiceRunner);
