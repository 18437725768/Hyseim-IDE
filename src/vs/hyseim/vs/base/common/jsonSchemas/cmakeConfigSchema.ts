...
import { SchemaArray, SchemaMap } from 'vs/hyseim/vs/base/common/jsonSchemaHelper/commonTypes';
import {
	CMAKE_CONFIG_FILE_NAME as CMAKE_CONFIG_FILE_NAME_NEW,
	CMAKE_LIBRARY_FOLDER_NAME as CMAKE_LIBRARY_FOLDER_NAME_NEW,
} from 'vs/hyseim/vs/base/common/constants/wellknownFiles';
import { DONT_MODIFY_MARKER } from 'vs/hyseim/vs/base/common/messages';
