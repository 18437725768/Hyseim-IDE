import { CMakeProjectTypes, ICompileInfoPossibleKeys, ICompileInfoReadonly, IExecutableProject, ILibraryProject } from 'vs/hyseim/vs/base/common/jsonSchemas/cmakeConfigSchema';
